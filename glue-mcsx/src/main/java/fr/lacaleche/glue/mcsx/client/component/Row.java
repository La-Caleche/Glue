...
public final class Row extends TaffyLayout {

    private final PropertyScope<Row> properties = new PropertyScope<>(this);
    ...
    public Row(Context context) {
        super(context, FlexDirection.ROW);
        this.setBackground(this.themedBackground);
        this.properties.setComponent(RowProperties.BACKGROUND_COLOR, 0);
        this.properties.setComponent(RowProperties.CORNER_RADIUS, 0);
    }
    ...
    public Row visible(boolean visible) {
        this.properties.set(RowProperties.VISIBLE, visible);
        return this;
    }

    public Row visible(Value<Boolean> visible) {
        this.properties.bind(RowProperties.VISIBLE, visible);
        return this;
    }

    public Row tag(Object tag) {
        this.setTag(tag);
        return this;
    }

    public Row classes(String... names) {
        this.style.classes(names);
        return this;
    }

    public Row part(String name) {
        this.style.part(name);
        return this;
    }

    public Row state(String name, Value<Boolean> value) {
    ...
    void applyStylesheetProperty(String property, StyleValue value) {
        if (property.equals("background")) {
            StylesheetProperty.apply(
                    this,
                    this.properties,
                    RowProperties.BACKGROUND_COLOR,
                    value
            );
