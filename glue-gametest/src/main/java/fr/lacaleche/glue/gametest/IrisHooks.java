...
/**
 * Thin guard around the Iris v0 API. Iris is a compileOnly dependency, so every caller must check
 * {@link #loaded()} before touching a method that resolves an Iris class.
 */
